...
public class SysUserServiceImpl implements ISysUserService, UserService {
     ...
     */
    @Override
    public List<SysUserVo> selectUserByIds(List<String> userIds, Long deptId) {
    ...
    public boolean registerUser(SysUserBo user, String tenantId) {
        user.setCreateBy(String.valueOf(0L));
        user.setUpdateBy(String.valueOf(0L));
        SysUser sysUser = MapstructUtils.convert(user, SysUser.class);
     ...
     */
    @Override
    public boolean updateUserAvatar(String userId, Long avatar) {
        return baseMapper.update(null,
            new LambdaUpdateWrapper<SysUser>()
     ...
     * @param clear   清除已存在的关联数据
     */
    private void insertUserRole(String userId, Long[] roleIds, boolean clear) {
    ...
    public String selectNicknameByIds(String userIds) {
        ...
        for (String id : StringUtils.split(userIds)) {
     ...
     */
    @Override
    public List<String> selectUserIdsByRoleIds(List<Long> roleIds) {
     ...
     */
    @Override
    public Map<String, String> selectUserNamesByIds(List<String> userIds) {
        if (CollUtil.isEmpty(userIds)) {
