...
@Component
public class ProStaffBoToProStaffMapperImpl implements ProStaffBoToProStaffMapper {

    @Override
    public ProStaff convert(ProStaffBo arg0) {
        if ( arg0 == null ) {
            return null;
        }
        ...
        proStaff.setSearchValue( arg0.getSearchValue() );
        proStaff.setCreateDept( arg0.getCreateDept() );
        proStaff.setCreateBy( arg0.getCreateBy() );
        proStaff.setCreateTime( arg0.getCreateTime() );
        proStaff.setUpdateBy( arg0.getUpdateBy() );
        proStaff.setUpdateTime( arg0.getUpdateTime() );
        Map<String, Object> map = arg0.getParams();
        if ( map != null ) {
            proStaff.setParams( new LinkedHashMap<String, Object>( map ) );
        }
    ...
    @Override
    public ProStaff convert(ProStaffBo arg0, ProStaff arg1) {
        if ( arg0 == null ) {
            return arg1;
        }
