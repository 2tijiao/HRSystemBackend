...
public class SysDeptBoToSysDeptMapperImpl implements SysDeptBoToSysDeptMapper {
    ...
    public SysDept convert(SysDeptBo arg0) {
        ...
        sysDept.setDeptNumber( arg0.getDeptNumber() );
        ...
        if ( arg0.getLeader() != null ) {
            sysDept.setLeader( String.valueOf( arg0.getLeader() ) );
        }
    ...
    public SysDept convert(SysDeptBo arg0, SysDept arg1) {
        ...
        if ( arg0.getLeader() != null ) {
            arg1.setLeader( String.valueOf( arg0.getLeader() ) );
        }
        else {
            arg1.setLeader( null );
        }
